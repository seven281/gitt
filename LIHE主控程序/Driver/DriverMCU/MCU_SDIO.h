...
#include "MCU_Uart3.h"
#include "MCU_Uart6.h"
#define sd_sdio_debug_printf(format, args...)   SystemPrintf(format, ##args) //变参宏定义
#else
#define sd_sdio_debug_printf(x, ...) \
    while (0)                        \
        ;
#endif
...
//查询模式,该模式下,如果读写有问题,建议增大SDIO_TRANSFER_CLK_DIV的设置.
