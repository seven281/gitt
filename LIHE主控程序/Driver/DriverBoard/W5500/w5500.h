...
uint16_t getIINCHIP_RxMAX(uint8 s);
uint16_t getIINCHIP_TxMAX(uint8 s);
...
void send_data_processing(SOCKET s, uint8 *wizdata, uint16_t len);
void recv_data_processing(SOCKET s, uint8 *wizdata, uint16_t len);
